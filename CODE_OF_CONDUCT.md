...
maintainers, privately, through the path this project's
[SECURITY.md](SECURITY.md) describes — never as a public issue, which is
what would out both the reporter and the incident to the community the
report is about. All complaints will be reviewed and investigated promptly
and fairly.
