...
This Code of Conduct applies within all community spaces across all three
repositories of the openDox project (`opensoft/openDox`,
`opensoft/openDox-spec`, `opensoft/openDox-code`), and also applies when an
...
maintainers, either publicly through an issue on the assembly root's issue
tracker, [`opensoft/openDox`](https://github.com/opensoft/openDox/issues), or
privately through the path this project's [SECURITY.md](SECURITY.md)
describes. All complaints will be reviewed and investigated promptly and
fairly.
